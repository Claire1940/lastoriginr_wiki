...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Last Origin R Wiki',
    description: 'Copyright and intellectual property information for Last Origin R Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Last Origin R Wiki',
      description: 'Copyright and intellectual property information for Last Origin R Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Last Origin R Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Last Origin R Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Last Origin R Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>VALOFE</strong> - Global publisher and platform operator for Last Origin R</li>
              <li><strong>Last Origin R Developers</strong> - Creators of the Last Origin R game</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>LAST ORIGIN R</strong> - Trademark of the official rights holders</li>
              <li><strong>Last Origin R</strong> - Trademark of the game developers</li>
              <li><strong>Last Origin R Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Last Origin R Wiki.
            </p>
            ...
            <p>
              ...
              Last Origin R Wiki<br />
              Email: <a href="mailto:dmca@lastoriginr.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@lastoriginr.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Last Origin R Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Last Origin R Wiki (lastoriginr.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@lastoriginr.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@lastoriginr.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@lastoriginr.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@lastoriginr.wiki</a>
            </p>
            <p>
