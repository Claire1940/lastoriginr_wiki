...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Last Origin R Wiki',
    description: 'Last Origin R Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our Last Origin R game resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Last Origin R Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <p>
              Our website may contain links to external websites, including VFUN, Google Play, App Store, Discord, and social media platforms.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Last Origin R Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with VALOFE, G.O.P Co., Ltd., or the developers of Last Origin R. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@lastoriginr.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@lastoriginr.wiki</a>
            </p>
            <p>
